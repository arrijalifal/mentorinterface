...
export default function Scene({ th1, th2, th3, th4, point, isInverse }: { th1: number; th2: number; th3: number; th4: number; point: { x: number, y: number, z: number }; isInverse: boolean | false }) {
    ...
    useFrame(() => {
        ...
        // const MLink2 = new THREE.Matrix4().multiplyMatrices(identity, TLink2).multiply(RLink2);
        // const MLink2 = identity;
        ...
        // const MLink3 = new THREE.Matrix4().multiplyMatrices(identity, TLink3).multiply(RLink3);
